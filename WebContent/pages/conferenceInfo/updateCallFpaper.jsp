  ...
  <div class="container">
    ...
    <div class="menu"> <a class="toggleMenu" href="#"><img src="<%=request.getContextPath()%>/images/nav_icon.png" alt="" /> </a>
      <ul class="nav" id="nav" >
        ...
        <li class="myPadding"><a href="callFpaper.jsp">会议发布</a></li>
  ...
  <div class="about">
  	<div class="container">
    	<section class="title-section">
     	 	<h1 class="title-header">会议征稿信息修改</h1>
    	</section>
  	</div>
   </div>
</div>
...
<div>
	<div class="container">
		<div class="row clearfix">
			...
			<c:forEach items="${queryByIdList}"  var="conference">
				<form name="myForm2" class="form-horizontal" onsubmit="return myCheck()" method="post" action="<%=request.getContextPath()%>/conferenceInfo/updateCFP.action?conference_id=${conference.conference_id}">
					<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<input name="conference_name" type="text" value="${conference.conference_name}" class="form-control myInput" id="conferenceName" style="height:39px;" required autofocus placeholder="请输入会议名称"  />
						</div>
					</div>
					<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<input name="confer_abbreviate" type="text" value="${conference.confer_abbreviate}"  class="form-control myInput" id="conferenceNameAbbreviation" required style="height:39px;" placeholder="请输入会议英文缩写名称，如IEEE2017"  />
						</div>
					</div>
				<%-- 	<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<input name="conference_class" type="text" value="${conference.conference_class}" class="form-control myInput" required style="height:39px;" placeholder="请输入会议英文缩写名称，如IEEE2017"  />
						</div>
					</div> --%>
					<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<input name="conference_date" type="date" value="<fmt:formatDate value="${conference.conference_date}" pattern="yyyy-MM-dd" />" class="form-control myInput" style="height:39px;" required placeholder="请输入会议开始日期" />
						</div>
					</div>
					<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<input name="paper_due" type="date"  value="<fmt:formatDate value="${conference.paper_due}" pattern="yyyy-MM-dd" />" class="form-control myInput" id="CFPEndDate" style="height:39px;" required placeholder="请输入征稿截止日期"  />
						</div>
					</div>
					<!-- div class="form-group" style="margin-bottom: 25px;">
					...
					<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<input name="conference_location" style="height:39px;" type="text" value="${conference.conference_location}" class="form-control myInput"  required id="conferenceLocation" placeholder="请输入会议地点"  />
					...
					<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<input name="conference_link" type="text" value="${conference.conference_link}" class="form-control myInput" id="conferenceLink" style="height:39px;" placeholder="请填写会议网址"  />
						</div>
					</div>
					<div class="form-group" style="margin-bottom: 25px;">
						...
						<div class="col-sm-10" style="width: 80.33333333%;">
							<textarea name="conference_abstract" class="form-control myInput" id="conferenceLocation" rows="3"  required  placeholder="请输入会议简介"  >${conference.conference_abstract}</textarea>
						</div>
					</div>
					...
					<div class="pagination pagination__posts">
						...
						<button id="post" type="submit" class="blog_btn myBtn" > 提 交 </button>
