    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body>
                ...
                <div class="headerAndabout" style="background: url(<%=request.getContextPath()%>/images/bg-pattern),linear-gradient(to left,#7b4397,#dc2430);
                      ...
                      <div class="container">
                          ...
                          <div class="menu"> <a class="toggleMenu" href="#"><img src="<%=request.getContextPath()%>/images/nav_icon.png" alt="" /> </a>
                              <ul class="nav" id="nav">
                                  ...
                                  <li class="current"><a href="categories.jsp">会议类别</a></li>
                                  <li><a href="callFpaper.jsp">发布会议</a></li>
